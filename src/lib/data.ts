...
export const galleryImages = [
  { src: "https://picsum.photos/600/800?random=8", alt: "Penteado de transformação do cliente 1", aiHint: "mens hairstyle" },
  { src: "https://picsum.photos/600/800?random=9", alt: "Penteado de transformação do cliente 2", aiHint: "cool hairstyle" },
