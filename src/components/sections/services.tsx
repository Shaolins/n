      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => {
            ...
            const isClassicCut = service.name === "Corte de Cabelo Clássico";
            return (
                ...
                <CardHeader className="p-0 relative w-full h-48">
                  {image && (
                    <Image
                      ...
                      alt={image.alt}
                      fill
                      className={isClassicCut ? "object-contain transition-transform duration-300 group-hover:scale-105" : "object-cover transition-transform duration-300 group-hover:scale-105"}
